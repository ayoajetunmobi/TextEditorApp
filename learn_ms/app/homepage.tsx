    ...
    return(
        <div>
            ...
            <div className="flex justify-center">
                <div className={`mt-15 w-[300px] p-5 border border-blue-100 rounded-[5px] ${create?"": "bg-green-100"}`}>
                    {create ? <p className="m-3 font-bold">create new project</p>:<p className="m-3 font-bold">join project</p>}
                    <label htmlFor=""> Group Name</label>
                    <input className="w-[250px] h-[30px] border outline-0 p-3 mb-4" type="text" name="" id="groupname" placeholder="enter a group name" />
                    
                    <label htmlFor=""> Group Key</label>
                    <input className="w-[250px] h-[30px] border outline-0 p-3 mb-4" type="text" name="" id="key" placeholder="enter group key/id" />
                    
                    <label htmlFor=""> Username</label>
                    <input className="w-[250px] h-[30px] border outline-0 p-3 mb-4" type="text" name="" id="username" placeholder="enter your username" />
