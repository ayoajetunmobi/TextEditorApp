...
class IBarcodeGenerator:
    ...
    def get_barcode_image(self, parameters: aspose.words.fields.BarcodeParameters) -> io.BytesIO:
        """Generate barcode image using the set of parameters (for DisplayBarcode field).
        
        :param parameters: The set of parameters
        :returns: Stream with image data representing generated barcode.
        
        Supported image formats are Bmp, Emf, Gif, Jpeg, Png, Tiff, Wmf, Pict, Ico, WebP, Svg."""
        ...
    
    def get_old_barcode_image(self, parameters: aspose.words.fields.BarcodeParameters) -> io.BytesIO:
