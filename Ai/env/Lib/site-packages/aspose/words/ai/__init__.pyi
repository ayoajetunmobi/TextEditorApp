...
class OpenAiModel(aspose.words.ai.AiModel):
    ...
    @overload
    def __init__(self, name: str, api_key: str):
        """Initializes a new instance of :class:`OpenAiModel` class.
        
        :param name: The name of the model. For example, gpt-5.2-chat-latest.
        :param api_key: The API key to use the OpenAi API."""
        ...
