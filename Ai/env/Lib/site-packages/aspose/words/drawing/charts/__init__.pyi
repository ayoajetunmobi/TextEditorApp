...
class ChartSeriesCollection:
    ...
    @overload
    def add_double(self, series_name: str, x_values: List[float]) -> aspose.words.drawing.charts.ChartSeries:
        """Adds new :class:`ChartSeries` to this collection.
    ...
    def add_bubbles(self, series_name: str, x_values: List[float], y_values: List[float], bubble_sizes: List[float]) -> aspose.words.drawing.charts.ChartSeries:
        """Adds new :class:`ChartSeries` to this collection.
